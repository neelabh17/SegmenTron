...
class ConfidenceHistogram(metrics.MaxProbCELoss):
    # @neelabh handle this later
    def plot(self, conf,obj, labels, n_bins = 15, logits = False, title = None):
...
# Iterative plotters
class ConfidenceHistogramIterative(metrics.MaxProbCELoss):

    def plot(self, bin_total, bin_total_correct, bin_conf_total, n_bins = 15, logits = False, title = None):
...
class ReliabilityDiagramIterative(metrics.MaxProbCELoss):
