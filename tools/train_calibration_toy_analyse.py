...
class Evaluator(object):
    def __init__(self, args):
        ...
        self.lr = 5
        self.prefix = "noiseClass_onlycce_50_25_15_10"
        ...
        for epoch in range(num_epochs):
            ...
            for i, (images, targets, filenames) in enumerate(self.val_loader):
                ...
                with torch.no_grad():
                    ...
                    outputs[0,0,100:200, 50:150] = 0.15
                    outputs[0,0,100:150, 250:300] = 0.25
                    outputs[0,1,100:200, 50:150] = 0.5
                    outputs[0,1,100:150, 250:300] = 0.15
                    outputs[0,2,100:200, 50:150] = 0.25
                    outputs[0,2,100:150, 250:300] = 0.5
